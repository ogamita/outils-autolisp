...
#+LANGUAGE: fr
#+OPTIONS: toc:2 num:t
#+TEXINFO_FILENAME: autolisp-hash-table.info
#+TEXINFO_DIR_CATEGORY: outils-autolisp
#+TEXINFO_DIR_TITLE: autolisp-hash-table: (autolisp-hash-table)
#+TEXINFO_DIR_DESC: Hash tables inspired by Common Lisp.
